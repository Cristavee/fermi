...
void   *fe_array_new(int64_t cap);
void    fe_array_push(void *arr, int64_t val);
int64_t fe_array_pop(void *arr);
int64_t fe_array_get(void *arr, int64_t idx);
void    fe_array_set(void *arr, int64_t idx, int64_t val);
int64_t fe_array_len(void *arr);
void    fe_array_free(void *arr);

void   *fe_map_new(void);
void    fe_map_set(void *map, const char *key, int64_t val);
int64_t fe_map_get(void *map, const char *key);
int32_t fe_map_has(void *map, const char *key);
void    fe_map_delete(void *map, const char *key);
void    fe_map_free(void *map);
